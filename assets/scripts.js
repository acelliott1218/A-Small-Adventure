...
const app = document.querySelector("#container", "#container2")
let state = {}
...
// madness ending
{
    ...
    options: [{
        text: `<p>"Home..."</p>`,
        nextText: -1,
        setState: { died: true, becameTree: true },
    },
    ]
},
    ...
    options: [
        {
            text: `<p>Fight back</p>`,
            nextText: 34,
            setState: {wonFight:true},
            requiredState: (currentState) => currentState.potion
        },
        {
            text: `<p>Fight back</p>`,
            nextText: -1,
            setState: {died:true, lostFight:true},
        },
        {
            text: `<p>Try to escape</p>`,
            nextText: -1,
            setState: {died:true, fledFight:true},
        },
        {
            text: `<p>Try to escape</p>`,
            nextText: 2,
            setState: {fledFight:true},
            requiredState:(currentState) => currentState.foot
        },
    ]
},
    ...
    options: [
        {
            ...
            nextText: 100,
            setState: {crown:true, naturalDisorder:true},
        },
    ]
},
{
